...
export default function GoogleReviews() {
  ...
  return (
    <section id="reviews" className="py-12 md:py-24 bg-gradient-to-b from-black via-gray-900 to-black relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-8 md:mb-16">
          <div className="inline-block px-4 py-2 bg-yellow-500/10 border border-yellow-500/30 rounded-full mb-3 md:mb-4">
        ...
        <div className="grid lg:grid-cols-2 gap-4 md:gap-8 items-center">
          <div className="bg-gradient-to-br from-blue-500/10 to-blue-600/10 border border-blue-500/30 rounded-2xl p-5 md:p-8">
            <div className="flex items-center gap-3 mb-4 md:mb-6">
              <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full flex items-center justify-center" style={{background: 'white'}}>
                <svg className="w-6 h-6 md:w-7 md:h-7" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <div>
                <h3 className="text-white font-bold text-lg md:text-xl">Google Reviews</h3>
            ...
            <p className="text-sm md:text-base text-gray-200 mb-5 md:mb-6 leading-relaxed">
            ...
            <a
              ...
              className="w-full justify-center inline-flex items-center gap-2 md:gap-3 px-4 md:px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-sm md:text-base text-white font-bold rounded-xl hover:shadow-[0_0_30px_rgba(59,130,246,0.5)] transition-all duration-300 hover:scale-105"
            >
          ...
          <div className="space-y-3 md:space-y-4">
            <div className="p-4 md:p-6 bg-white/5 backdrop-blur-sm border border-yellow-500/20 rounded-2xl hover:border-yellow-500/50 transition-all duration-300">
